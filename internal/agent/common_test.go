...
func coderAgent(r *vcr.Recorder, env fakeEnv, large, small fantasy.LanguageModel) (SessionAgent, error) {
	...
	allTools := []fantasy.AgentTool{
		tools.NewBashTool(env.permissions, env.workingDir, cfg.Config().Options.Attribution, modelName, false),
		...
		tools.NewViewTool(nil, env.permissions, *env.filetracker, nil, env.workingDir, cfg.Config().Tools.View),
